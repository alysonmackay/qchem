...
if args.show or args.showbl or args.shownl:
    ...
    ax.scatter(*xyzarr[narr].T,s=100/len(xyzarr) * 50,color='blue',alpha=0.5)
    ax.scatter(*xyzarr[oarr].T,s=100/len(xyzarr) * 50,color='red')
    ax.scatter(*xyzarr[sarr].T,s=200/len(xyzarr) * 50,color='yellow')
    ax.scatter(*xyzarr[marr].T,s=300/len(xyzarr) * 50,color='purple',alpha=1)
